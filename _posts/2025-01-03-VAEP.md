...
<figure class="chart-image">
  <img src="{{ site.baseurl }}/assets/VAEP_Plots/vaep_violin_plots_by_position_category.png" alt="Violin Plot of Cumulative VAEP by Position Categories" />
  <figcaption>
    Violin Plot of Cumulative VAEP by Position Categories
  </figcaption>
</figure>
