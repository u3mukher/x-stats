...
<!-- Updated Leicester City Plot -->
<iframe 
  src="{{ '/assets/Leicester_City_percentile_map_main_body.html' | relative_url }}"
  width="1200"  <!-- Increased from 1000 to 1200 to match Plotly's width -->
  height="700"  <!-- Increased from 500 to 700 to accommodate the colorbar -->
  scrolling="no"
  style="border:none; overflow:hidden;">
</iframe>
