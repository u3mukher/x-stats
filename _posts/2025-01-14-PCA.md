...
Here, each (p<sub>i</sub>-t<sub>i</sub>) measures how differently the player and team score on the i-th principal component, and **smaller** distances imply a closer stylistic match. Despite the two PCAs being separate, if they capture broadly similar ideas (e.g., attacking vs. defensive, possession vs. direct), then teams that lie “close” to a player often turn out to be better real-world fits.
