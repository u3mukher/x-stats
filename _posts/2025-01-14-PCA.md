...
Below is an excerpt of the **loadings** for each metric on each principal component in the **Player PCA**. Loadings indicate how strongly each metric influences that principal component. A positive loading means that metric **increases** along the PC axis; a negative loading means it **decreases**.

| **Metric**                | **PC1**   | **PC2**   | **PC3**   | **PC4**   | **PC5**   | **PC6**   | **PC7**   | **PC8**   | **PC9**   | **PC10**  | **PC11**  | **PC12**  | **PC13**  |
|---------------------------|----------:|----------:|----------:|----------:|----------:|----------:|----------:|----------:|----------:|----------:|----------:|----------:|----------:|
| **possession**            | -0.0129   | -0.0091   |  0.9725   |  0.1948   |  0.0771   | -0.0884   |  0.0078   | -0.0081   | -0.0386   |  0.0197   | -0.0063   | -0.0040   | -0.0126   |
| **pass_completion_rate**  | -0.0172   |  0.3086   | -0.1836   |  0.7051   |  0.0189   | -0.4815   | -0.2340   |  0.2710   | -0.0497   |  0.0792   | -0.0597   |  0.0295   | -0.0096   |
| **player_pass_len_avg**   | -0.2771   |  0.2628   |  0.0171   | -0.3813   |  0.4478   | -0.1944   |  0.0317   |  0.1430   |  0.0799   |  0.2696   | -0.6065   | -0.0175   |  0.0370   |
| **progressive_passes_per_90** | -0.1081   |  0.4813   |  0.0555   | -0.4059   |  0.1461   | -0.2064   | -0.2443   |  0.0727   | -0.1565   | -0.0303   |  0.6584   |  0.0329   |  0.0058   |
| **xG_per_90**             |  0.4278   | -0.0343   | -0.0283   |  0.0253   |  0.2920   | -0.1284   |  0.1840   | -0.0773   | -0.0654   |  0.0001   |  0.0625   | -0.0038   |  0.8152   |
| **shots_per_90**          |  0.4341   |  0.0183   | -0.0090   | -0.0631   |  0.1568   | -0.0951   |  0.1541   | -0.0127   | -0.0821   |  0.0279   | -0.0412   |  0.7937   | -0.3323   |
| **key_passes_per_90**     |  0.3319   |  0.1933   |  0.0548   | -0.2262   | -0.3270   | -0.1509   | -0.2400   | -0.0340   | -0.4258   | -0.4858   | -0.4060   | -0.1657   | -0.0166   |
| **duel_success_rate**     | -0.0920   |  0.4206   |  0.0192   |  0.0039   | -0.3657   | -0.1076   |  0.8062   |  0.0903   |  0.0529   | -0.0744   |  0.0259   | -0.0412   |  0.0092   |
| **interceptions_per_90**  |  0.0525   |  0.4922   |  0.0131   |  0.1618   |  0.1276   |  0.2798   | -0.1621   | -0.4605   |  0.5294   | -0.3149   | -0.0953   |  0.0789   |  0.0301   |
| **counterattacks_per_90** |  0.3343   | -0.1332   |  0.0714   | -0.2121   | -0.1219   | -0.1952   | -0.0972   |  0.5337   |  0.6619   | -0.1424   |  0.0429   | -0.1076   | -0.0372   |
| **setpiece_xG_per_90**    |  0.3903   |  0.0078   | -0.0674   |  0.0730   |  0.4523   | -0.0930   |  0.2326   | -0.1663   | -0.0595   |  0.0210   |  0.1028   | -0.5549   | -0.4693   |
| **fouls_committed_per_90**|  0.2087   |  0.3019   |  0.0332   |  0.1134   |  0.0967   |  0.7030   | -0.0341   |  0.5350   | -0.2004   |  0.1276   | -0.0315   | -0.0493   |  0.0214   |
| **dribbles_per_90**       |  0.3325   |  0.1923   |  0.0438   | -0.0982   | -0.4197   | -0.0272   | -0.1685   | -0.2730   |  0.0892   |  0.7357   | -0.0379   | -0.1018   |  0.0058   |
...
**Note**: PC1 is quite strong for players, explaining over 35% of total variance. The loadings suggest it heavily ties to offensive metrics such as `shots_per_90` and `xG_per_90`.

---

#### Team PCA: Loadings & Explained Variance

Below is a table of loadings for the **Team PCA**, focusing on the same or analogous metrics but aggregated at the team level:

| **Metric**                        | **PC1**   | **PC2**   | **PC3**   | **PC4**   | **PC5**   | **PC6**   | **PC7**   | **PC8**   | **PC9**   | **PC10**  | **PC11**  | **PC12**  | **PC13**  |
|-----------------------------------|----------:|----------:|----------:|----------:|----------:|----------:|----------:|----------:|----------:|----------:|----------:|----------:|----------:|
| **team_possession**               |  0.3595   |  0.1395   | -0.2243   | -0.0980   |  0.0686   |  0.2251   | -0.1350   | -0.0853   |  0.1875   | -0.3555   | -0.1057   |  0.7320   | -0.0439   |
| **team_pass_completion_rate**     |  0.3288   |  0.1814   | -0.3687   |  0.0867   |  0.0471   |  0.0569   | -0.1312   |  0.1739   |  0.2824   | -0.4046   |  0.3212   | -0.5356   |  0.1707   |
| **team_pass_len_avg**             | -0.2581   | -0.2575   |  0.1067   | -0.4330   |  0.0948   | -0.4301   | -0.1876   |  0.4452   |  0.4493   | -0.1652   | -0.0650   |  0.0864   | -0.0009   |
| **team_progressive_passes_per_90**|  0.3199   |  0.0519   | -0.1990   | -0.3776   |  0.1362   | -0.1414   | -0.3545   | -0.4075   |  0.1583   |  0.4641   | -0.3004   | -0.2222   | -0.0506   |
| **team_xG_per_90**                |  0.3204   | -0.2765   |  0.2307   | -0.1499   | -0.0115   |  0.1452   | -0.3261   |  0.1781   | -0.1691   |  0.2866   |  0.6685   |  0.1361   | -0.0984   |
| **team_shots_per_90**             |  0.3326   | -0.3121   |  0.0581   | -0.0990   |  0.1381   | -0.1703   |  0.4314   | -0.0779   | -0.0286   |  0.0493   |  0.0010   |  0.0855   |  0.7266   |
| **team_key_passes_per_90**        |  0.3358   | -0.2474   | -0.0372   | -0.1195   |  0.0724   | -0.1775   |  0.5639   | -0.0678   |  0.0415   | -0.1263   |  0.0464   | -0.1054   | -0.6482   |
| **team_duel_success_rate**        |  0.2381   |  0.3486   | -0.0218   |  0.1573   |  0.4645   | -0.3839   | -0.0730   |  0.4389   | -0.4467   |  0.0710   | -0.1533   |  0.0668   | -0.0541   |
| **team_interceptions_per_90**     | -0.0495   |  0.4201   |  0.5582   | -0.3986   |  0.2234   | -0.0213   |  0.0250   | -0.3478   | -0.0995   | -0.3515   |  0.1811   | -0.1052   |  0.0366   |
| **team_counterattacks_per_90**    |  0.1566   | -0.2185   |  0.4535   |  0.6135   |  0.3110   | -0.0705   | -0.2197   | -0.1855   |  0.3775   | -0.0508   | -0.1083   | -0.0245   | -0.0619   |
| **team_setpiece_xG_per_90**       |  0.2898   | -0.3024   |  0.2461   | -0.1185   | -0.3294   |  0.1742   | -0.2466   |  0.1582   | -0.3573   | -0.3486   | -0.4766   | -0.2212   |  0.0047   |
| **team_fouls_committed_per_90**   | -0.2167   | -0.2635   | -0.1175   | -0.1628   |  0.6701   |  0.5889   |  0.0489   |  0.1079   | -0.0623   | -0.0044   | -0.1134   | -0.1272   | -0.0207   |
| **team_dribbles_per_90**          |  0.2302   |  0.3702   |  0.3358   | -0.0754   | -0.1452   |  0.3599   |  0.2754   |  0.4137   |  0.3788   |  0.3376   | -0.1846   | -0.0481   |  0.0072   |
...
**Note**: For teams, PC1 captures ~46% of total variance and correlates strongly with `team_possession`, `team_pass_completion_rate`, `team_xG_per_90`, etc.—suggesting an axis of **possession + attacking** style. Lower components highlight more specific traits, like longer-pass strategies, counterattacks, and so on.

---

### Why Some Metrics Are “Insignificant”

PCA zooms in on the biggest axes of variance in each dataset. Metrics that appear with very small loadings (like `xG_per_90` in certain components) are overshadowed by stronger signals—maybe certain leagues or clubs vary more in possession and passing length than in xG, so xG doesn’t dominate early components.

---

### Comparing Players & Teams for “Fit”

Because we use **two separate** PCA spaces, it’s not a pure linear-algebraic match. However, each space captures *broadly similar* stylistic axes:

- For **players**, one dimension might be “attacking emphasis” (shots, xG) versus more defensive or possession roles.  
- For **teams**, one dimension might be “possession and passing” versus direct/counterattacking play.

By **subtracting** a player’s PCA coordinates from a team’s PCA coordinates, we get a **distance** that measures how similarly (or differently) they score on these style axes. This is a heuristic—**not** a perfect alignment—but in practice, if the main principal components parallel each other (e.g. both revolve around offense vs. defense, or possession vs. direct play), then teams that rank “closer” to a player often match that player’s style, just as we see in real-life transfer success.
